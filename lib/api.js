...
var api = {
  ...
  addRequestHeaders: function(reqOptions) {
      console.log('-------------------------------------api reqOptions before addheaders-------------------------------');
  ...
  // Runtime fetch of Auth singleton to prevent circular module dependencies
    ...
    return api.getAccessToken().then(function(result) {
      ...
      console.log('-------------------------------------api reqOptions after addheaders-------------------------------');
      console.log(reqOptions);
      return reqOptions;
    });
  },
  request: function(method, resource, options) {
    ...
    console.log('-------------------------------------api options before request headers--------------------------');
    console.log(options);
    ...
    if (options.auth === true) {
      return api.addRequestHeaders(reqOptions).then(function(reqOptionsWithToken) {
        ...
        // console.log(method + ' '+ options.origin + ' ' +resource);
        // console.log('----------------------api reqOptionsWithToken-----------------------');
        // console.log(reqOptionsWithToken);
        return _request(reqOptionsWithToken);
      });
    }
    // console.log('----------------------uploadSource reqOptions-----------------------');
    // console.log(reqOptions);
