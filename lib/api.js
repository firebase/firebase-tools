...
var api = {
  realtimeUrl: utils.envOverride('FIREBASE_REALTIME_URL', 'https://firebaseio.com'),
  adminUrl: utils.envOverride('FIREBASE_ADMIN_URL', 'https://admin.firebase.com'),
  uploadUrl: utils.envOverride('FIREBASE_UPLOAD_URL', 'https://hosting.firebase.com'),
  hostingUrl: utils.envOverride('FIREBASE_HOSTING_URL', 'https://firebaseapp.com'),
  websiteUrl: utils.envOverride('FIREBASE_WEBSITE_URL', 'https://www.firebase.com'),
  request: function(method, resource, options) {
    // Runtime fetch of Auth singleton to prevent circular module dependencies
    var auth = require('./auth');
    options = _.extend({
      data: {},
      origin: api.adminUrl // default to hitting the admin backend
    }, options);
