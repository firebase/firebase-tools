 ...
 * @return {object} a StructuredQuery.
 */
FirestoreDelete.prototype._docDescendantsQuery = function(
  allDescendants,
  batchSize
) {
  return {
 ...
 */
FirestoreDelete.prototype._getDescendantBatch = function(
  allDescendants,
  batchSize
) {
  var url;
...
FirestoreDelete.prototype._recursiveBatchDelete = function() {
  var self = this;
  return this._getDescendantBatch(this.allDescendants, this.batchSize).then(
    function(docs) {
      if (docs.length <= 0) {
        return RSVP.resolve();
      }
