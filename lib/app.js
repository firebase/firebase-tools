...
var supportedTemplates = {
  angular: {
    ...
    completedMessage: 'BOOTSTRAPPING SUCCESSFUL'.green + ' - For more ' +
                        'information on the template see ' +
              ...
              if (settings.rules) {
                ...
                if (rules) {
                  auth.updateRules(settings.firebase, rules, function(err) {
                    ...
                    console.log('DEPLOYED SUCCESSFULLY'.green + ' - See your ' +
                                    'app at ' + url);
                  });
                } else {
                ...
                console.log('DEPLOYED SUCCESSFULLY'.green + ' - See your app ' +
                                  'at ' + url);
              }
            });
          });
