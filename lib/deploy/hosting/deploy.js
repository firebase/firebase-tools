...
module.exports = function(context, options, payload) {
  ...
  utils.logBullet(chalk.bold.cyan('hosting:') + ' preparing ' + chalk.bold(payload.hosting.public) + ' directory for upload...');
    ...
    return new RSVP.Promise(function(resolve, reject) {
      ...
      local.versionRef.on('value', function(snap) {
        ...
        case 'deployed':
          ...
          utils.logSuccess(chalk.bold.green('hosting:') + ' ' + upload.manifest.length + ' files uploaded successfully');
