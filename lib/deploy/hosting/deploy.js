...
module.exports = function(context, options, payload) {
  ...
  return prepareUpload(options, payload.hosting)
    .then(function(upload) {
      ...
      if (!upload.manifest.length) {
        return utils.reject("Must have at least one file in public directory to deploy.", {
          exit: 1,
        });
      }
      ...
      return new Promise(function(resolve, reject) {
        ...
        api
          .request("PUT", "/v1/hosting/" + options.instance + "/uploads/" + local.versionId, {
            auth: true,
            query: {
