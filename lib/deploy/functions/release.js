...
module.exports = function(context, options, payload) {
  ...
  console.log('--------------LOOOOOOOOOOOOOOOOOOOK HEREEEEEEEEEEEEEEEEEEEEE-------------------');
  console.log(context.uploadUrl);

  var GCP_REGION = 'us-central1';
  var projectId = context.projectId;
  var sourceUrl = 'gs://' + context.functionsBucket + '/' + gcp.storage.archiveName;
  var uploadUrl = context.uploadUrl;
    ...
    _.chain(existingFunctions)
      .filter(function(functionInfo) {
        if (typeof functionInfo.labels === 'undefined') {
          return functionInfo.sourceArchiveUrl === sourceUrl || functionInfo.sourceArchiveUrl === legacySourceUrl || functionInfo.sourceUploadUrl === sourceUploadUrl;
        }
