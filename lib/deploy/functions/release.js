    ...
    var addOps = _.chain(uploadedNames)
      ...
      .map(function(functionName) {
        ...
        return _prepFunctionOp(functionInfo, functionName, projectId).then(function(functionTriggers) {
          ...
          return gcp.cloudfunctions.create(projectId, GCP_REGION, functionName, functionTriggers, sourceUrl);
        });
      }).value();
    ...
    var updateOps = _.chain(uploadedNames)
      ...
      .map(function(functionName) {
        ...
        return _prepFunctionOp(functionInfo, functionName, projectId).then(function(functionTriggers) {
          ...
          return gcp.cloudfunctions.update(projectId, GCP_REGION, functionName, functionTriggers, sourceUrl);
        });
      }).value();
