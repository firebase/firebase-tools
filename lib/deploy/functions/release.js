...
module.exports = function(context, options, payload) {
  ...
  var stagingLegacySourceUrl = 'gs://' + context.functionsBucket + '/' + gcp.storage.archiveName;
    ...
    _.chain(existingFunctions)
      .filter(function(functionInfo) {
        if (typeof functionInfo.labels === 'undefined') {
          return functionInfo.sourceUploadUrl === sourceUrl || functionInfo.sourceArchiveUrl === stagingLegacySourceUrl || functionInfo.sourceArchiveUrl === legacySourceUrl;
        }
