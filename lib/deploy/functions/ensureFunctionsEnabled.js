...
var _checkEnabled = function(projectId) {
  return api.request('GET', '/v1/services/cloudfunctions.googleapis.com/projectSettings/' + projectId + '?view=CONSUMER_VIEW', {
    auth: true,
...
var _enableFunctionsApi = function(projectId) {
  return api.request('PATCH', '/v1/services/cloudfunctions.googleapis.com/projectSettings/' + projectId + '?updateMask=usageSettings', {
    auth: true,
    data: {
