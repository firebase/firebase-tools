...
module.exports = function(context, options, payload) {
  ...
  if (options.config.get('functions')) {
    ...
    return _checkBilling().then(function(response) {
      if (!response.body.billingEnabled) {
        ...
        + 'https://firebase.corp.google.com/project/' + context.projectId + '/overview');
      }
