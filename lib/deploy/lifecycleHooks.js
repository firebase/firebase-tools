...
function runCommand(command, child_options) {
  return new Promise(function(resolve, reject) {
    var child = child_process.spawn(command, [], child_options);
...
module.exports = function(target, hook) {
  ...
  return function(context, options) {
    ...
    child_env.GCLOUD_PROJECT = projectId;
    child_env.PROJECT_DIR = projectDir;
    child_env.RESOURCE_DIR = resourceDir;
    ...
    var runAllCommands = _.reduce(commands, function(soFar, command) {
      return soFar.then(function() {
        return runCommand(command, child_options);
      });
    }, Promise.resolve());
