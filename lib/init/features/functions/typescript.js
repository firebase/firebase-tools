...
var TEMPLATE_ROOT = path.resolve(
  __dirname,
  "../../../../templates/init/functions/typescript/"
);
...
var TSLINT_TEMPLATE = fs.readFileSync(
  path.join(TEMPLATE_ROOT, "tslint.json"),
  "utf8"
);
var TSCONFIG_TEMPLATE = fs.readFileSync(
  path.join(TEMPLATE_ROOT, "tsconfig.json"),
  "utf8"
);
var INDEX_TEMPLATE = fs.readFileSync(
  path.join(TEMPLATE_ROOT, "index.ts"),
  "utf8"
);
