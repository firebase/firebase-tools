...
FunctionsEmulator.prototype._getPorts = function() {
  console.log('inside _getPorts, options are: ', this.options)
  var portsConfig = {
...
FunctionsEmulator.prototype.start = function() {
  ...
  var controllerConfig = _.merge({tail: true}, ports); // TODO: specify REST client
  var firebaseConfig;
