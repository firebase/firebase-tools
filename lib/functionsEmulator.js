...
FunctionsEmulator.prototype.start = function(shellMode) {
  ...
  var funcIntervals = _setIdleFunctionsIntervals();
  var controllerConfig = _.merge({tail: true, service: 'rest'}, ports, {host: this.options.host}, {bindHost: this.options.host}, funcIntervals);
  var firebaseConfig;
