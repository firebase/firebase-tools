...
function pollDeploys(operations, printSuccess, printFail, printTooManyOps) {
  var interval;
  ...
  return pollOperations
    ...
    .catch(function() {
      ...
      logger.info(
        "You can check on their status at " + utils.consoleUrl(options.project, "/functions/logs")
      );
