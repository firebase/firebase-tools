...
module.exports = {
  send: function(firebase, publicDir, pushId, callback) {
    ...
    writeStream.once('finish', function() {
      var url = api.uploadUrl + '/upload/' + firebase + '?id=' + encodeURIComponent(pushId) + '&fileCount=' + fileCount + '&token=' + auth.token
