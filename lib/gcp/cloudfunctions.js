...
function _createFunction(options) {
  ...
  console.log('------------------------cloudfunction creating function---------------------------');
  console.log(options.sourceArchiveUrl);
  console.log(options.sourceUploadUrl);
  var data = {
...
function _updateFunction(options) {
  ...
  console.log('------------------------cloudfunction updating function---------------------------');
  console.log(options.sourceArchiveUrl);
  console.log(options.sourceUploadUrl);
  var data = _.assign({
    sourceArchiveUrl: options.sourceArchiveUrl,
  ...
  var masks = ['sourceArchiveUrl', 'sourceUploadUrl', 'name', 'labels'];
