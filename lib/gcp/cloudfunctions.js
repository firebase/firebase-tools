...
function _createFunction(projectId, region, functionName, entryPoint, trigger, gcsUrl) {
...
function _updateFunction(projectId, region, functionName, entryPoint, trigger, gcsUrl) {
  var location = 'projects/' + projectId + '/locations/' + region;
  var func = location + '/functions/' + functionName;
