...
async function updatePackageJson(nonInteractive, projectDir) {
    ...
    switch (choice) {
        case "overwrite":
            ...
            break;
        case "merge":
            newPackageJson = Object.assign(Object.assign(Object.assign({}, packageJson), existingPackageJson), { 
                // Main will always be overwritten to match tsconfig.
                main: packageJson.main, scripts: Object.assign(Object.assign({}, packageJson.scripts), existingPackageJson.scripts) });
            break;
        case "keep":
