...
class FunctionsEmulator {
    ...
    async startPython(backend, envs) {
        ...
        const childProcess = (0, python_1.runWithVirtualEnv)(args, backend.functionsDir, Object.assign(Object.assign(Object.assign({}, process.env), envs), { 
            ...
            DEBUG: "False", HOST: "127.0.0.1", PORT: port.toString() }));
        return {
            process: childProcess,
            events: new events_1.EventEmitter(),
            cwd: backend.functionsDir,
