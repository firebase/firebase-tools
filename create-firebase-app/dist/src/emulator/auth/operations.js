...
function generateJwt(user, { projectId, signInProvider, expiresInSeconds, extraClaims = {}, secondFactor, tenantId, signInAttributes, }) {
    ...
    const customPayloadFields = Object.assign(Object.assign(Object.assign({ 
        ...
        name: user.displayName, picture: user.photoUrl }, customAttributes), extraClaims), { 
        // Reserved fields (set after custom attributes):
        email: user.email, email_verified: user.emailVerified, phone_number: user.phoneNumber, 
        ...
        provider_id: signInProvider === "anonymous" ? signInProvider : undefined, auth_time: (0, utils_1.toUnixTimestamp)(getAuthTime(user)), user_id: user.localId, firebase: {
            identities,
