...
exports.dbAction = functions.database
  .ref("/input/{uuid}")
...
exports.nested = {
  dbAction: functions.database
    .ref("/inputNested/{uuid}")
    .onCreate(function (snap, context) {
      console.log("Received snap:", snap);
      return snap.ref.root
        .child("output/" + context.params.uuid)
        .set(snap.val());
    }),
};
...
exports.pubsubAction = functions.pubsub
  .topic("topic1")
