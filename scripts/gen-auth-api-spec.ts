...
async function main(): Promise<void> {
  ...
  addPasskeyOperations(merged.output);
  ...
  const formattedSpec = await prettier.format(specContent, {
    ...prettierOptions,
    filepath: specFile,
  });
...
function addPasskeyOperations(openapi3: any): void {
  // Add passkey info schema to GoogleCloudIdentitytoolkitV1UserInfo
  if (openapi3.components.schemas.GoogleCloudIdentitytoolkitV1UserInfo) {
    openapi3.components.schemas.GoogleCloudIdentitytoolkitV1UserInfo.properties.passkeyInfo = {
      type: "array",
      items: {
        $ref: "#/components/schemas/GoogleCloudIdentitytoolkitV1PasskeyInfo",
      },
      description: "Passkeys enrolled for this user.",
    };
  }

  // Add deletePasskey to SetAccountInfoRequest
  if (openapi3.components.schemas.GoogleCloudIdentitytoolkitV1SetAccountInfoRequest) {
    openapi3.components.schemas.GoogleCloudIdentitytoolkitV1SetAccountInfoRequest.properties.deletePasskey =
      {
        type: "array",
        items: {
          type: "string",
  ...
  // Define PasskeyInfo schema
  openapi3.components.schemas.GoogleCloudIdentitytoolkitV1PasskeyInfo = {
    type: "object",
    properties: {
  ...
  openapi3.components.schemas.GoogleCloudIdentitytoolkitV2StartPasskeyEnrollmentRequest = {
    type: "object",
    properties: {
      idToken: { type: "string" },
  ...
  openapi3.components.schemas.GoogleCloudIdentitytoolkitV2StartPasskeyEnrollmentResponse = {
    type: "object",
    properties: {
      credentialCreationOptions: { type: "object" },
    },
  };

  openapi3.components.schemas.GoogleCloudIdentitytoolkitV2FinalizePasskeyEnrollmentRequest = {
    type: "object",
    properties: {
      idToken: { type: "string" },
      tenantId: { type: "string" },
  ...
  openapi3.components.schemas.GoogleCloudIdentitytoolkitV2FinalizePasskeyEnrollmentResponse = {
    type: "object",
    properties: {
      localId: { type: "string" },
      idToken: { type: "string" },
  ...
  openapi3.components.schemas.GoogleCloudIdentitytoolkitV2StartPasskeySignInRequest = {
    type: "object",
    properties: {
      tenantId: { type: "string" },
    },
  ...
  openapi3.components.schemas.GoogleCloudIdentitytoolkitV2StartPasskeySignInResponse = {
    type: "object",
    properties: {
      credentialRequestOptions: { type: "object" },
    },
  };

  openapi3.components.schemas.GoogleCloudIdentitytoolkitV2FinalizePasskeySignInRequest = {
    type: "object",
    properties: {
      tenantId: { type: "string" },
  ...
  openapi3.components.schemas.GoogleCloudIdentitytoolkitV2FinalizePasskeySignInResponse = {
    type: "object",
    properties: {
      idToken: { type: "string" },
      refreshToken: { type: "string" },
  ...
  // Define paths
  openapi3.paths["/v2/accounts/passkeyEnrollment:start"] = {
    post: {
  ...
  openapi3.paths["/v2/accounts/passkeyEnrollment:finalize"] = {
    post: {
  ...
  openapi3.paths["/v2/accounts/passkeySignIn:start"] = {
    post: {
  ...
  openapi3.paths["/v2/accounts/passkeySignIn:finalize"] = {
    post: {
