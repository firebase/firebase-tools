...
npm ci --prefix scripts/webframeworks-deploy-tests/nextjs --legacy-peer-deps
npm ci --prefix scripts/webframeworks-deploy-tests/angular --legacy-peer-deps
npm ci --prefix scripts/webframeworks-deploy-tests/functions --legacy-peer-deps
