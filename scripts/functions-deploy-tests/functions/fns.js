...
import { v1Opts, v2Opts } from "./options.js";
...
export const v1scheduled = withOptions.pubsub.schedule("every 30 minutes").onRun(() => {});
...
// TODO: Task queue function options are mostly broken.
