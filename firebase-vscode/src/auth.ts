...
import * as apiv2 from "../../src/apiv2";
import { configstore } from "../../src/configstore";
import { FirebaseError } from "../../src/error";
import * as utils from "../../src/utils";
import { logger } from "../../src/logger";
import { promptOnce } from "../../src/prompt";
import * as scopes from "../../src/scopes";
import { clearCredentials } from "../../src/defaultCredentials";
...
async function respondWithFile(
  ...
  const response = fs.readFileSync(path.join(__dirname, filename));
