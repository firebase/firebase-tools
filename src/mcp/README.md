...
| firebase_get_environment            | core          | Retrieves information about the current Firebase environment including current user, project directory, active project, and more.                                                                                                                                |
...
| crashlytics_list_top_issues         | crashlytics   | List the top issues happening in the application.                                                                                                                                                                                      |