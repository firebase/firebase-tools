...
describe("list_projects tool", () => {
  ...
  it("should list the first page of projects", async () => {
    ...
    const result = await (list_projects as any)._fn({ page_size: pageSize });
  ...
  it("should list a subsequent page of projects", async () => {
    ...
    const result = await (list_projects as any)._fn({ page_size: pageSize, page_token: pageToken });
  ...
  it("should throw a descriptive error on failure", async () => {
    ...
    await expect((list_projects as any)._fn({})).to.be.rejectedWith(
