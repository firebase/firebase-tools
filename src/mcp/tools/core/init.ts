...
export const init = tool(
  {
    name: "init",
    description:
      "Use this to initializes selected Firebase features in the workspace (Firestore, Data Connect, Realtime Database, Firebase AI Logic). All features are optional; provide only the products you wish to set up. " +
