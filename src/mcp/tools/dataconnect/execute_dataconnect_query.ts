...
export const execute_dataconnect_query = tool(
  {
    name: "execute_dataconnect_query",
    description:
      "Executes a deployed Data Connect query. Cannot write any data.",
    inputSchema: z.object({
      ...
      variables: z.record(z.string()).optional().describe("Variables for this operation. Use get_dataconnect_connector to find the expected variables for this query"),
    }),
    annotations: {
