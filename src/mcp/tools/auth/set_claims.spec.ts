...
describe("set_claim tool", () => {
  ...
  it("should set a simple claim", async () => {
    ...
    const result = await set_claim.fn({ uid, claim, value }, { projectId } as any);
  ...
  it("should set a JSON claim", async () => {
    ...
    const result = await set_claim.fn({ uid, claim, json_value }, { projectId } as any);
  ...
  it("should return an error for invalid JSON", async () => {
    ...
    await set_claim.fn({ uid, claim, json_value }, { projectId } as any);
  ...
  it("should return an error if both value and json_value are provided", async () => {
    ...
    await set_claim.fn({ uid, claim, value, json_value }, { projectId } as any);
