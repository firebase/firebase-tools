...
export function createApp(
  ...
  /**
   * WARNING: This endpoint should NOT be depended on by developers and has no guarantees of longterm support.
   * To update rules, use hot reloading or restart the Storage emulator.
   *
   * Internal endpoint to overwrite current rules. Callers provide either a single set of rules to
   * be applied to all resources or an array of rules/resource objects.
   *
