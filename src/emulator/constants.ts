...
export class Constants {
  ...
  static FIREBASE_GA_ENABLED = "FIREBASE_GA_ENABLED";
  static FIREBASE_GA_MEASUREMENT_ID = "FIREBASE_GA_MEASUREMENT_ID";
  static FIREBASE_GA_CLIENT_ID = "FIREBASE_GA_CLIENT_ID";
