...
export interface paths {
  ...
  "/v2/accounts/passkeyEnrollment:start": {
    ...
    post: operations["identitytoolkit.accounts.passkeyEnrollment.start"];
  };
  "/v2/accounts/passkeyEnrollment:finalize": {
    /** Finalize passkey enrollment. */
    post: operations["identitytoolkit.accounts.passkeyEnrollment.finalize"];
  };
  "/v2/accounts/passkeySignIn:start": {
    /** Start passkey sign-in. */
    post: operations["identitytoolkit.accounts.passkeySignIn.start"];
  };
  "/v2/accounts/passkeySignIn:finalize": {
    /** Finalize passkey sign-in. */
    post: operations["identitytoolkit.accounts.passkeySignIn.finalize"];
  };
}
...
export interface components {
  schemas: {
    ...
    GoogleCloudIdentitytoolkitV1UserInfo: {
      ...
      passkeyInfo?: components["schemas"]["GoogleCloudIdentitytoolkitV1PasskeyInfo"][];
    };
    /** @description Warning notifications for the user. */
    ...
    GoogleCloudIdentitytoolkitAdminV2Config: {
      ...
      mobileLinksConfig?: components["schemas"]["GoogleCloudIdentitytoolkitAdminV2MobileLinksConfig"];
    ...
    GoogleCloudIdentitytoolkitAdminV2MobileLinksConfig: {
      ...
      domain?: "DOMAIN_UNSPECIFIED" | "FIREBASE_DYNAMIC_LINK_DOMAIN" | "HOSTING_DOMAIN";
    };
    ...
    GoogleCloudIdentitytoolkitAdminV2RecaptchaConfig: {
      ...
      tollFraudManagedRules?: components["schemas"]["GoogleCloudIdentitytoolkitAdminV2RecaptchaTollFraudManagedRule"][];
    ...
    GoogleCloudIdentitytoolkitV2RecaptchaEnforcementState: {
      ...
      provider?: "RECAPTCHA_PROVIDER_UNSPECIFIED" | "EMAIL_PASSWORD_PROVIDER" | "PHONE_PROVIDER";
    };
    ...
    GoogleCloudIdentitytoolkitV2StartPasskeyEnrollmentResponse: {
      credentialCreationOptions?: { [key: string]: unknown };
    };
    GoogleCloudIdentitytoolkitV2FinalizePasskeyEnrollmentRequest: {
      idToken?: string;
      tenantId?: string;
      authenticatorRegistrationResponse?: { [key: string]: unknown };
      name?: string;
      displayName?: string;
    };
    ...
    GoogleCloudIdentitytoolkitV2StartPasskeySignInResponse: {
      credentialRequestOptions?: { [key: string]: unknown };
    };
    GoogleCloudIdentitytoolkitV2FinalizePasskeySignInRequest: {
      tenantId?: string;
      authenticatorAuthenticationResponse?: { [key: string]: unknown };
      name?: string;
      displayName?: string;
    };
...
export interface operations {
  ...
  "identitytoolkit.accounts.passkeyEnrollment.start": {
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["GoogleCloudIdentitytoolkitV2StartPasskeyEnrollmentResponse"];
        };
      };
    };
    requestBody: {
      content: {
        "application/json": components["schemas"]["GoogleCloudIdentitytoolkitV2StartPasskeyEnrollmentRequest"];
      };
    };
  };
  /** Finalize passkey enrollment. */
  "identitytoolkit.accounts.passkeyEnrollment.finalize": {
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["GoogleCloudIdentitytoolkitV2FinalizePasskeyEnrollmentResponse"];
        };
      };
    };
    requestBody: {
      content: {
        "application/json": components["schemas"]["GoogleCloudIdentitytoolkitV2FinalizePasskeyEnrollmentRequest"];
      };
    };
  };
  /** Start passkey sign-in. */
  "identitytoolkit.accounts.passkeySignIn.start": {
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["GoogleCloudIdentitytoolkitV2StartPasskeySignInResponse"];
        };
      };
    };
    requestBody: {
      content: {
        "application/json": components["schemas"]["GoogleCloudIdentitytoolkitV2StartPasskeySignInRequest"];
      };
    };
  };
  /** Finalize passkey sign-in. */
  "identitytoolkit.accounts.passkeySignIn.finalize": {
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["GoogleCloudIdentitytoolkitV2FinalizePasskeySignInResponse"];
        };
      };
    };
    requestBody: {
      content: {
        "application/json": components["schemas"]["GoogleCloudIdentitytoolkitV2FinalizePasskeySignInRequest"];
      };
    };
  };
}
