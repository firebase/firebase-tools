...
const _emulators = {
  ...
  firestore: {
    ...
    cacheDir: CACHE_DIR,
    remoteUrl:
      "https://storage.googleapis.com/firebase-preview-drop/emulator/cloud-firestore-emulator-v1.2.4.jar",
    localPath: path.join(CACHE_DIR, "cloud-firestore-emulator-v1.2.4.jar"),
  },
};
