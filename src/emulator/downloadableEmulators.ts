...
export const DownloadDetails: { [s in DownloadableEmulators]: EmulatorDownloadDetails } = {
  ...
  ui: {
    version: "1.6.1",
    downloadPath: path.join(CACHE_DIR, "ui-v1.6.1.zip"),
    unzipDir: path.join(CACHE_DIR, "ui-v1.6.1"),
    binaryPath: path.join(CACHE_DIR, "ui-v1.6.1", "server.bundle.js"),
    opts: {
      cacheDir: CACHE_DIR,
      remoteUrl: "https://storage.googleapis.com/firebase-preview-drop/emulator/ui-v1.6.1.zip",
      expectedSize: 3755780,
      expectedChecksum: "c56d794e773fb58842b7fd9e7c5ef0ce",
      namePrefix: "ui",
    },
  },
  pubsub: {
