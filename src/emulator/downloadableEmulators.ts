...
const DownloadDetails: { [s in DownloadableEmulators]: EmulatorDownloadDetails } = {
  ...
  gui: {
    version: "0.0.2",
    downloadPath: path.join(CACHE_DIR, "gui-v0.0.2.zip"),
    unzipDir: path.join(CACHE_DIR, "gui-v0.0.2"),
    binaryPath: path.join(CACHE_DIR, "gui-v0.0.2", `server.bundle.js`),
    opts: {
      cacheDir: CACHE_DIR,
      remoteUrl: "https://storage.googleapis.com/firebase-preview-drop/emulator/gui-v0.0.2.zip",
      expectedSize: 2805795,
      expectedChecksum: "495f467c448dee53abc19e26e6191b26",
      namePrefix: "gui",
    },
  },
  pubsub: {
