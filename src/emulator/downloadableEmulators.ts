...
export const DownloadDetails: { [s in DownloadableEmulators]: EmulatorDownloadDetails } = {
  ...
  ui: {
    ...
    downloadPath: path.join(CACHE_DIR, "ui-v1.6.0-SNAPSHOT.zip"),
    unzipDir: path.join(CACHE_DIR, "ui-v1.6.0-SNAPSHOT"),
    binaryPath: path.join(CACHE_DIR, "ui-v1.6.0-SNAPSHOT", "server.bundle.js"),
    opts: {
      cacheDir: CACHE_DIR,
      remoteUrl:
        "https://storage.googleapis.com/firebase-preview-drop/emulator/ui-v1.6.0-SNAPSHOT.zip",
      expectedSize: -1,
      expectedChecksum: "",
      skipChecksumAndSize: true,
      skipCache: true,
