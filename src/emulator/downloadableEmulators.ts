...
const DownloadDetails: { [s in DownloadableEmulators]: EmulatorDownloadDetails } = {
  ...
  gui: {
    version: "0.0.3",
    downloadPath: path.join(CACHE_DIR, "gui-v0.0.3.zip"),
    unzipDir: path.join(CACHE_DIR, "gui-v0.0.3"),
    binaryPath: path.join(CACHE_DIR, "gui-v0.0.3", `server.bundle.js`),
    opts: {
      cacheDir: CACHE_DIR,
      remoteUrl: "https://storage.googleapis.com/firebase-preview-drop/emulator/gui-v0.0.3.zip",
      expectedSize: 2751701,
      expectedChecksum: "1f6c312d7d7c571204c61590a0e5509a",
      namePrefix: "gui",
    },
  },
  pubsub: {
