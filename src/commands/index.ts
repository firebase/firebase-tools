...
export function load(client: CLIClient): CLIClient {
  ...
  client.crashlytics.issues.get = loadCommand("crashlytics-issues-get");
  client.crashlytics.issues.update = loadCommand("crashlytics-issues-update");
  client.crashlytics.notes = {};
  client.crashlytics.notes.create = loadCommand("crashlytics-notes-create");
  client.crashlytics.notes.list = loadCommand("crashlytics-notes-list");
  client.crashlytics.notes.delete = loadCommand("crashlytics-notes-delete");
  client.crashlytics.reports = {};
  client.crashlytics.reports.get = loadCommand("crashlytics-reports-get");
  client.crashlytics.events = {};
  client.crashlytics.events.list = loadCommand("crashlytics-events-list");
  client.crashlytics.events.batchget = loadCommand("crashlytics-events-batchget");
  client.database = {};
