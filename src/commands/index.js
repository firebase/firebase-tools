...
module.exports = function (client) {
  ...
  client.functions.env = {};
  client.functions.env.add = loadCommand("functions-env-add");
  client.functions.env.clear = loadCommand("functions-env-clear");
  client.functions.env.clone = loadCommand("functions-env-clone");
  client.functions.env.get = loadCommand("functions-env-get");
  client.functions.env.remove = loadCommand("functions-env-remove");
  client.functions.env.set = loadCommand("functions-env-set");
