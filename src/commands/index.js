...
module.exports = function (client) {
  ...
  client.hosting.domains.create = loadCommand("hosting-domains-create");
  client.hosting.domains.delete = loadCommand("hosting-domains-delete");
  client.hosting.domains.get = loadCommand("hosting-domains-get");
