...
export const command = new Command("login")
  ...
  .action(async (options: any) => {
    ...
    if (!options.reauth) {
      utils.logBullet(
        "Firebase CLI integrates with Gemini in Firebase API to provide assistive features. Learn more about using Gemini in Firebase and how we train our models: https://firebase.google.com/docs/gemini-in-firebase/set-up-gemini#required-permissions",
      );
