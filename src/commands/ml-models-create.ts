...
module.exports = new Command("ml:models:create <displayName> [source]")
  ...
  .option("-t, --tags <tag1,tag2>", "(optional) one or more comma separated tags to add to the model")
  .action(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    async (displayName: string, source: string | undefined, options: any): Promise<FirebaseModel> => {
